...
@Component({
  ...
  styleUrls: ['./vehicles-star-wars.component.css']
})
export class VehiclesStarWarsComponent {

  vehicles = VEHICLES.results;

  getVehicleImageUrl(vehicleUrl: string) {
    var vehicleId = vehicleUrl.split('/').reverse()[1];
